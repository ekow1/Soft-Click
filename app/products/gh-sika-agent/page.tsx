...
export default function SikaAgentPage() {
  return (
    <>
      <PageHero
        title="GH Sika Agent."
        description="A complete, secured, and affordable revenue collection app for field agents, bringing mobile banking to the forefront."
        align="left"
        sectionNumber="02"
        sectionLabel="Mobile Product"
      />
          ...
          <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8 mb-16 lg:mb-20">
            ...
            <div className="col-span-12 lg:col-span-9">
              <h2 className="swiss-headline text-foreground text-4xl md:text-5xl lg:text-6xl mb-6">
                Revenue collection <span className="text-muted-foreground">simplified.</span>
              </h2>
              <p className="swiss-body text-muted-foreground text-base md:text-lg max-w-2xl mb-8">
                GH Sika Agent eliminates the risk of field agents under-reporting cash collected. It works on any Android phone and provides live monitoring, automated daily reporting, and instant SMS prompts to increase customer confidence.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  "Cash Deposit & Withdrawal Requests", 
      ...
      <section className="w-full bg-[#020617] text-white border-b-2 border-white/10 py-20 md:py-28 swiss-noise relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-12 relative z-10">
          <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8 mb-16 lg:mb-20">
            ...
            <div className="col-span-12 lg:col-span-9">
              <h2 className="swiss-headline text-white text-4xl md:text-5xl lg:text-6xl">
                How GH Sika Agent <span className="text-white/40">works.</span>
              </h2>
            </div>
          </div>
          ...
          <div className="w-full max-w-4xl mx-auto group relative aspect-video bg-muted/20 border-2 border-white/10 overflow-hidden cursor-pointer">
            <img 
              src="/images/products/payroll-pro.png" 
              alt="Sika Agent Video Thumbnail" 
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
              <h3 className="swiss-headline text-2xl">Sika Agent Mobile Demo</h3>
              <p className="swiss-label text-white/70">Field Collection & Live Monitoring</p>
            </div>
          </div>
        </div>
      </section>
