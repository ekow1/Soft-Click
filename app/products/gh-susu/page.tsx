...
export default function GHSusuPage() {
  return (
    <>
      <PageHero
        title="GH Susu (GASCA)."
        description="Customized mobile application managing daily collections efficiently for over 155 susu operators."
        align="left"
        sectionNumber="04"
        sectionLabel="Susu Product"
      />
          ...
          <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8 mb-16 lg:mb-20">
            ...
            <div className="col-span-12 lg:col-span-9">
              <h2 className="swiss-headline text-foreground text-4xl md:text-5xl lg:text-6xl mb-6">
                Susu operations <span className="text-muted-foreground">streamlined.</span>
              </h2>
              <p className="swiss-body text-muted-foreground text-base md:text-lg max-w-2xl mb-8">
                Designed specifically for the Ghana Susu Association (GASCA), this product replaces manual receipting with secure electronic transactions, making daily deposit management and commission tracking flawless.
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  "Automated Client Balance Enquiry", 
                  "Detailed Management Reports", 
                  "Secure Cloud Backup Keeping"
                ].map((item, i) => (
        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-12 relative z-10">
          <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8 mb-16 lg:mb-20">
            ...
            <div className="col-span-12 lg:col-span-9">
              <h2 className="swiss-headline text-white text-4xl md:text-5xl lg:text-6xl">
                How GH Susu <span className="text-white/40">works.</span>
              </h2>
            </div>
          </div>
          ...
          <div className="w-full max-w-4xl mx-auto group relative aspect-video bg-muted/20 border-2 border-white/10 overflow-hidden cursor-pointer">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
              <h3 className="swiss-headline text-2xl">GH Susu Field Operations</h3>
              <p className="swiss-label text-white/70">Collection & Syncing Demo</p>
            </div>
          </div>
        </div>
      </section>
