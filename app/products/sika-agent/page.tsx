...
export default function SikaAgentPage() {
  return (
    <>
      <PageHero
        title="Sika Agent GH."
        description="Agent Banking Solution empowering financial inclusion across Ghana through mobile agents."
        align="left"
        sectionNumber="00"
          ...
          <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8 mb-16 lg:mb-20">
            ...
            <div className="col-span-12 lg:col-span-9">
              <h2 className="swiss-headline text-foreground text-4xl md:text-5xl lg:text-6xl mb-6">
                Agent banking <span className="text-muted-foreground">simplified.</span>
              </h2>
              <p className="swiss-body text-muted-foreground text-base md:text-lg max-w-2xl">
                Sika Agent GH enables financial institutions to extend their reach through a network of mobile banking agents. Built for offline-first operation in rural areas, it connects millions to formal financial services.
              </p>
            </div>
          </div>
        </div>
