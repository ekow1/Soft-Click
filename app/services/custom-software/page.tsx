  ...
  return (
    <>
      <PageHero
        ...
        description="Tailored software solutions built to address your unique business challenges and opportunities."
        align="left"
        sectionNumber="00"
          ...
          <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8 mb-16 lg:mb-20">
            ...
            <div className="col-span-12 lg:col-span-9">
              <h2 className="swiss-headline text-foreground text-4xl md:text-5xl lg:text-6xl mb-6">
                Software built <span className="text-muted-foreground">for you.</span>
              </h2>
              <p className="swiss-body text-muted-foreground text-base md:text-lg max-w-2xl">
                We design and develop custom software solutions that align perfectly with your business processes. From concept to deployment, our team ensures your software is scalable, secure, and delivers measurable business value.
              </p>
            </div>
          </div>
        </div>
