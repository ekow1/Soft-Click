...
export default function CloudPage() {
  return (
    <>
      <PageHero
        title="Cloud Hosting."
        description="Scalable cloud infrastructure ensuring your applications are always available, secure, and performant."
        align="left"
        sectionNumber="00"
          ...
          <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8 mb-16 lg:mb-20">
            ...
            <div className="col-span-12 lg:col-span-9">
              <h2 className="swiss-headline text-foreground text-4xl md:text-5xl lg:text-6xl mb-6">
                Infrastructure <span className="text-muted-foreground">scaled.</span>
              </h2>
              <p className="swiss-body text-muted-foreground text-base md:text-lg max-w-2xl">
                We deploy and manage cloud infrastructure on AWS, Azure, and other leading platforms. Our solutions ensure high availability, automatic scaling, and cost optimization for your mission-critical applications.
              </p>
            </div>
          </div>
        </div>
