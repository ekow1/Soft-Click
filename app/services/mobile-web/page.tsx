  ...
  return (
    <>
      <PageHero
        ...
        description="Cross-platform applications that reach your users wherever they are, on any device."
        align="left"
        sectionNumber="00"
          ...
          <div className="grid grid-cols-12 gap-4 md:gap-6 lg:gap-8 mb-16 lg:mb-20">
            ...
            <div className="col-span-12 lg:col-span-9">
              <h2 className="swiss-headline text-foreground text-4xl md:text-5xl lg:text-6xl mb-6">
                Applications <span className="text-muted-foreground">everywhere.</span>
              </h2>
              <p className="swiss-body text-muted-foreground text-base md:text-lg max-w-2xl">
                We build responsive web applications and native mobile apps that provide seamless user experiences across all platforms. Whether iOS, Android, or web, your users get consistent, high-performance access to your services.
              </p>
            </div>
          </div>
        </div>
